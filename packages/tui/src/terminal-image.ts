 ...
 * Uses 24-bit range so the ID fits in a true-color foreground value,
 * which is required by the Unicode placeholder protocol.
 */
export function allocateImageId(): number {
	// 24-bit range [1, 0xffffff] — fits in true-color fg for placeholders
